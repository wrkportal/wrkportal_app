...
import { MoreVertical, BarChart3, TrendingUp, FileText, Users, TrendingDown, Map, AlertTriangle, ClipboardList, Network, Palette, Link as LinkIcon, Briefcase, CheckCircle2, Target, Plus, X, UserCheck, Clock, GripVertical, List, Calendar, Filter, ChevronLeft, ChevronRight } from 'lucide-react'
...
export const defaultWidgets: Widget[] = [
  ...
  { id: 'invoices', type: 'invoices', visible: true },
  { id: 'forecast', type: 'forecast', visible: true },
  { id: 'expenses', type: 'expenses', visible: true },
...
export const defaultLayouts: Layouts = {
  lg: [
    { i: 'stats', x: 0, y: 0, w: 12, h: 4, minW: 4, minH: 3 },
    { i: 'invoices', x: 0, y: 4, w: 8, h: 8, minW: 4, minH: 6 },
    { i: 'forecast', x: 8, y: 4, w: 4, h: 8, minW: 3, minH: 6 },
    { i: 'expenses', x: 0, y: 12, w: 12, h: 8, minW: 4, minH: 6 },
    { i: 'roadmap', x: 0, y: 20, w: 6, h: 8, minW: 3, minH: 4 },
    { i: 'metrics', x: 6, y: 20, w: 6, h: 8, minW: 3, minH: 4 },
    { i: 'blockers', x: 0, y: 28, w: 6, h: 8, minW: 3, minH: 4 },
    { i: 'teamCapacity', x: 6, y: 28, w: 6, h: 8, minW: 3, minH: 4 },
    { i: 'recentProjects', x: 0, y: 36, w: 6, h: 8, minW: 3, minH: 4 },
    { i: 'myTasks', x: 6, y: 36, w: 6, h: 10, minW: 3, minH: 6 },
    { i: 'assignedToOthers', x: 0, y: 46, w: 6, h: 8, minW: 3, minH: 6 },
    { i: 'activeOKRs', x: 6, y: 44, w: 6, h: 8, minW: 3, minH: 3 },
    { i: 'quickActions', x: 0, y: 54, w: 6, h: 6, minW: 3, minH: 4 },
    { i: 'usefulLinks', x: 6, y: 52, w: 6, h: 6, minW: 3, minH: 4 },
    { i: 'forms', x: 0, y: 60, w: 6, h: 8, minW: 3, minH: 4 },
    { i: 'mindMap', x: 6, y: 60, w: 6, h: 8, minW: 3, minH: 6 },
    { i: 'canvas', x: 0, y: 68, w: 6, h: 8, minW: 3, minH: 8 },
    { i: 'ganttChart', x: 6, y: 68, w: 6, h: 10, minW: 4, minH: 8 },
  ],
  md: [
    { i: 'stats', x: 0, y: 0, w: 10, h: 4, minW: 4, minH: 3 },
    { i: 'invoices', x: 0, y: 4, w: 6, h: 8, minW: 4, minH: 6 },
    { i: 'forecast', x: 6, y: 4, w: 4, h: 8, minW: 3, minH: 6 },
    { i: 'expenses', x: 0, y: 12, w: 10, h: 8, minW: 4, minH: 6 },
    { i: 'roadmap', x: 0, y: 20, w: 5, h: 8, minW: 3, minH: 4 },
    { i: 'metrics', x: 5, y: 20, w: 5, h: 8, minW: 3, minH: 4 },
    { i: 'blockers', x: 0, y: 28, w: 5, h: 8, minW: 3, minH: 4 },
    { i: 'teamCapacity', x: 5, y: 28, w: 5, h: 8, minW: 3, minH: 4 },
    { i: 'recentProjects', x: 0, y: 36, w: 5, h: 8, minW: 3, minH: 4 },
    { i: 'myTasks', x: 5, y: 36, w: 5, h: 10, minW: 3, minH: 6 },
    { i: 'assignedToOthers', x: 0, y: 46, w: 5, h: 8, minW: 3, minH: 6 },
    { i: 'activeOKRs', x: 5, y: 44, w: 5, h: 8, minW: 3, minH: 3 },
    { i: 'quickActions', x: 0, y: 54, w: 5, h: 6, minW: 3, minH: 4 },
    { i: 'usefulLinks', x: 5, y: 52, w: 5, h: 6, minW: 3, minH: 4 },
    { i: 'forms', x: 0, y: 60, w: 5, h: 8, minW: 3, minH: 4 },
    { i: 'mindMap', x: 5, y: 60, w: 5, h: 8, minW: 3, minH: 6 },
    { i: 'canvas', x: 0, y: 68, w: 5, h: 8, minW: 3, minH: 8 },
    { i: 'ganttChart', x: 5, y: 68, w: 5, h: 10, minW: 4, minH: 8 },
  ],
  sm: [
    { i: 'stats', x: 0, y: 0, w: 6, h: 4, minW: 3, minH: 3 },
    { i: 'invoices', x: 0, y: 4, w: 6, h: 8, minW: 3, minH: 6 },
    { i: 'forecast', x: 0, y: 12, w: 6, h: 8, minW: 3, minH: 6 },
    { i: 'expenses', x: 0, y: 20, w: 6, h: 8, minW: 3, minH: 6 },
    { i: 'roadmap', x: 0, y: 28, w: 6, h: 8, minW: 2, minH: 4 },
    { i: 'metrics', x: 0, y: 36, w: 6, h: 8, minW: 2, minH: 4 },
    { i: 'blockers', x: 0, y: 44, w: 6, h: 8, minW: 2, minH: 4 },
    { i: 'teamCapacity', x: 0, y: 52, w: 6, h: 8, minW: 2, minH: 4 },
    { i: 'recentProjects', x: 0, y: 60, w: 6, h: 8, minW: 2, minH: 4 },
    { i: 'myTasks', x: 0, y: 68, w: 6, h: 10, minW: 2, minH: 6 },
    { i: 'assignedToOthers', x: 0, y: 78, w: 6, h: 8, minW: 2, minH: 6 },
    { i: 'activeOKRs', x: 0, y: 86, w: 6, h: 8, minW: 2, minH: 3 },
    { i: 'quickActions', x: 0, y: 94, w: 6, h: 6, minW: 2, minH: 4 },
    { i: 'usefulLinks', x: 0, y: 100, w: 6, h: 6, minW: 2, minH: 4 },
    { i: 'forms', x: 0, y: 106, w: 6, h: 8, minW: 2, minH: 4 },
    { i: 'mindMap', x: 0, y: 114, w: 6, h: 8, minW: 2, minH: 6 },
    { i: 'canvas', x: 0, y: 122, w: 6, h: 8, minW: 2, minH: 8 },
    { i: 'ganttChart', x: 0, y: 130, w: 6, h: 10, minW: 2, minH: 8 },
  ],
}
...
export default function FinanceDashboardLandingPage() {
  ...
  const stats = [
    { label: "Revenue (MTD)", value: "₹38.4L" },
    { label: "Expenses (MTD)", value: "₹22.1L" },
    { label: "Cash on Hand", value: "₹1.78Cr" },
    { label: "Outstanding Receivables", value: "₹42.6L" },
  ]
  ...
  const forecast = [
    { label: "Next 30 Days", value: "₹61.8L revenue", risk: "Low" },
    { label: "Quarter End", value: "₹1.82Cr projection", risk: "Medium" },
    { label: "Year End", value: "₹7.46Cr projection", risk: "Stable" },
  ]
    ...
    const loadLayouts = async () => {
      ...
      if (saved) {
        try {
          ...
          // Filter out removed widgets (like leaderboard) and merge with defaults
        ...
        try {
          ...
          if (dbDefault?.widgets) {
            ...
            const mergedWidgets = defaultWidgets.map(defaultWidget => {
              ...
              return dbWidget && validWidgetIds.has(dbWidget.id) 
                ? { ...defaultWidget, visible: dbWidget.visible || defaultWidget.visible }
                : defaultWidget
            })
            setWidgets(mergedWidgets)
          } else {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex w-full">
      <main className="flex-1 flex flex-col w-full m-0 p-0">
        ...
        <FinanceNavBar widgets={widgets} toggleWidget={toggleWidget} />
        ...
        <div className="flex-1 overflow-y-auto px-4 lg:px-8 py-4 lg:py-6">
          ...
          <footer className="pt-6 pb-4 text-[11px] text-muted-foreground">
            <span>Finance clarity = business clarity.</span>
          </footer>
        </div>
      </main>
    </div>
