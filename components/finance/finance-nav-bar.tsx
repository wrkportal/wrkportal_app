...
import { WidgetGalleryDialog } from './widget-gallery-dialog'
...
export function FinanceNavBar({ widgets, toggleWidget }: FinanceNavBarProps = {}) {
  ...
  const navItems = [
    { label: "Dashboard", href: "/finance-dashboard", icon: LayoutDashboard, hasDropdown: false },
      ...
      <div className="pr-4 lg:pr-8">
        <nav className="flex items-center gap-1 text-sm">
          ...
          <div className="flex items-center gap-2 pl-4 pr-4 py-3 mr-4">
            <span className="text-2xl font-bold tracking-tight bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Finance</span>
          </div>
