  ...
  try {
    ...
    if (projectId) {
      ...
      const project = {
        ...
        ownerId: (projectData as any).ownerId || '',
        managerId: (projectData as any).managerId || '',
        teamMembers: [],
        startDate: (projectData as any).startDate || new Date(),
        endDate: (projectData as any).endDate || new Date(),
        plannedStartDate: (projectData as any).plannedStartDate || new Date(),
        plannedEndDate: (projectData as any).plannedEndDate || new Date(),
        budget: {} as any,
      ...
      const risks = projectData.risks.map((r: Risk) => ({
        ...
        probability: (r.probability as any) || 3,
        impact: (r.impact as any) || 3,
        score: ((r.probability as any) || 3) * ((r.impact as any) || 3),
        ...
        targetDate: (r as any).targetDate || undefined,
        resolvedDate: (r as any).resolvedDate || undefined,
      ...
      const issues = projectData.issues.map((i: Issue) => ({
        ...
        ownerId: (i as any).ownerId || '',
        reporterId: (i as any).reporterId || '',
        escalationLevel: (i as any).escalationLevel || 0,
        identifiedDate: (i as any).identifiedDate || i.reportedDate || new Date(),
