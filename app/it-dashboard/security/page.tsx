  ...
  const [vulnerabilities] = useState<Vulnerability[]>([
    {
      ...
      severity: 'HIGH',
      affectedSystems: 'Web Server (prod-01)',
    ...
    },
    {
      ...
      severity: 'CRITICAL',
      affectedSystems: 'Windows Servers (5 servers)',
      discoveredDate: '2024-12-08',
      status: 'OPEN',
      patchAvailable: true,
    },
  ])
  ...
  const [incidents] = useState<Incident[]>([
    {
      ...
      reportedAt: '2024-12-15T09:00:00',
      status: 'IN_PROGRESS',
      assignee: 'John Doe',
    },
    {
      ...
      type: 'Malware',
      severity: 'CRITICAL',
      description: 'Anti-malware system blocked ransomware attempt',
      reportedAt: '2024-12-14T14:30:00',
      status: 'RESOLVED',
      assignee: 'Jane Smith',
    },
  ])
