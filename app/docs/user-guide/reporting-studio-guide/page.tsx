...
export default function ReportingStudioGuidePage() {
  const [content, setContent] = useState<string>('')
  const [loading, setLoading] = useState(true)

  useEffect(() => {
    fetch('/api/docs/user-guide/reporting-studio-guide.md')
      .then((res) => {
      ...
      .catch((error) => {
        ...
        setContent('# Reporting Studio Guide\n\nContent loading...')
        setLoading(false)
      })
  }, [])
