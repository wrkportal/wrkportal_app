 ...
 * Renders the quick start guide markdown content
 */
...
export default function QuickStartGuidePage() {
  ...
  useEffect(() => {
    ...
    fetch('/api/docs/quick-start/quick-start-guide.md')
      .then((res) => {
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10 max-w-4xl mt-4 sm:mt-6 lg:mt-8">
      ...
      <Card>
        <CardContent className="prose prose-lg max-w-none p-4 sm:p-6 lg:p-8">
          {loading ? (
